...
public class PeerConnection {
  ...
  public static class IceServer {
    ...
    public static class Builder {
      ...
      public Builder setTlsAlpnProtocols(List<String> tls_alpn_protocols) {
        this.tls_alpn_protocols = tls_alpn_protocols;
        return this;
      }

      public IceServer createIceServer() {
        return new IceServer(uri, username, password, tlsCertPolicy, hostname, tls_alpn_protocols);
      }
    }
  }
