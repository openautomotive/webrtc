...
struct UlpfecConfig {
  ...
  // side. On the receive side, it's replaced by
  // VideoReceiveStream::Config::Rtp::rtx_payload_types, but it
  // appears that mapping is populated based on values in this struct.
