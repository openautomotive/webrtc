...
class AudioProcessing : public rtc::RefCountInterface {
 public:
  ...
  struct Config {
    ...
    // Enables and disables the post processor. It may only be enabled if an
    // instance has been provided to the audio processing module upon
    // construction.
  ...
  // Allows passing in a user-defined post processing module.
  static AudioProcessing* Create(const webrtc::Config& config,
