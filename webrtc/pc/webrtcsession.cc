...
void WebRtcSession::RemoveVideoChannel(cricket::VideoChannel* video_channel) {
  auto it =
...
void WebRtcSession::RemoveVoiceChannel(cricket::VoiceChannel* voice_channel) {
  auto it =
